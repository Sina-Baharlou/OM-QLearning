...
public:
	...
	Vec2i* opponentPos;						// -- Agent Opponent
	// -- Distributions --
...
public:
	...
	QAgent(cv::Mat& stateMap,bool randInit,	RewardGenerator* rewardEngine);
	...
	float getBestAction(Vec2i position,Action& action);		// -- Search for the best action from the learned Q-Values
